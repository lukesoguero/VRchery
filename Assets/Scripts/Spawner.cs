...
public class Spawner : MonoBehaviour
{
    ...
    private Dictionary<EnemyType, GameObject> Enemies = new Dictionary<EnemyType, GameObject>(4);
    //----------------------------------
    ...
    void Start()
    {
        ...
        Enemies.Add(EnemyType.Easy, EasyEnemy);
        Enemies.Add(EnemyType.Boss, BossEnemy);
        Enemies.Add(EnemyType.Medium, MediumEnemy);
        Enemies.Add(EnemyType.Hard, HardEnemy);
    }
    ...
    {
        GameObject Enemy = (GameObject)Instantiate(Enemies[enemyType], gameObject.transform.position, Quaternion.identity);
